...
import { MonitorOrgButton } from './monitor-org-button';
        ...
        <div className="max-w-4xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="mt-3 mb-2 flex items-start justify-between gap-4">
            ...
            <div className="shrink-0 pt-1">
              <MonitorOrgButton ein={org.ein} orgName={org.name} compact />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-300 rounded-lg p-6">
            ...
            <p className="text-sm text-green-800 mb-4">
              Add it to a monitored group and get alerted when a new audit, finding, repeat finding,
              or management-decision deadline shows up — instead of checking back.
            </p>
            <MonitorOrgButton ein={org.ein} orgName={org.name} />
            <p className="text-xs text-green-800 mt-3">
              Checking several at once?{' '}
              <a href={`/portfolio?eins=${org.ein}`} className="underline font-semibold">
                Portfolio view →
              </a>
            </p>
          </div>
