...
//           while still catching a genuine runaway. Briefly dropped to
//           300 during the Sep 2026 spike; reverted — once federal_awards
//           is cached (lib/federal-awards.ts) the fix is the cache, not a
//           tighter batch cap, and 300 was low enough that a short
//           crawler burst locked *signed-in users* out of a cold-EIN
//           lookup for the rest of the hour even with quota to spare.
